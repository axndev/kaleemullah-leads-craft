...
const WhyChooseMe = () => {
  const reasons = [
    ...
    },
    {
      ...
      description: "100+ successful projects with measurable outcomes. Real solutions that drive business growth."
    },
    {
      icon: Users,
  ...
  return (
    <section className="py-24 sm:py-32 bg-gradient-hero relative overflow-hidden">
      {/* Decorative elements */}
